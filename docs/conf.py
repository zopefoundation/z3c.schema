# -*- coding: utf-8 -*-
#
# z3c.schema documentation build configuration file, created by
...
htmlhelp_basename = 'z3cschemadoc'
...
latex_documents = [
    (master_doc, 'z3cschema.tex', u'z3c.schema Documentation',
...
man_pages = [
    (master_doc, 'z3cschema', u'z3c.schema Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'z3cschema', u'z3c.schema Documentation',
     author, 'z3cschema', 'One line description of project.',
     'Miscellaneous'),
]
